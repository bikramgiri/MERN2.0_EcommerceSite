      ...
      <div className="flex flex-col lg:flex-row lg:gap-12 bg-white  shadow-sm overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-6 md:p-8 lg:p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            ...
            <button
              type="button"
              className="cursor-pointer flex-1 flex items-center justify-center rounded-xl px-8 py-4 text-base font-semibold text-indigo-700 border-2 border-indigo-700 hover:bg-indigo-50 transition-colors"
            >
